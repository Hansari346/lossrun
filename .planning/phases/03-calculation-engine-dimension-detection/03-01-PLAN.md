...
must_haves:
  truths:
    ...
    - "When a dimension has insufficient data, its corresponding breakdown section contains no entries"
    - "Results carry dimension metadata so charts and exports know which analyses are available"
